...
export class FwsAbnormalNonSensed {
  ...
  public ewdAbnormalNonSensed: EwdAbnormalDict = {
    ...
    270900004: {
      ...
      notActiveWhenItemActive: [],
      whichItemsToShow: () => [
        this.fws.flapLeverLessThan2.get() || this.fws.flapLever2.get(),
        this.fws.flapLever3.get(),
        this.fws.flapLeverLessThan2.get(),
        this.fws.flapLeverLessThan2.get(),
        true,
        true,
        true,
    ...
    700900001: {
      ...
      whichItemsChecked: () => [
        ...
        false,
        false,
        this.fws.engineStartSelNorm.get(),
    ...
    700900002: {
      ...
      whichItemsChecked: () => [
        ...
        this.fws.apuAvailAndApuBleedOn.get(),
        false,
        this.fws.engineStartSelCrank.get(),
        false,
        false,
        false,
        this.fws.engineStartSelNorm.get(),
