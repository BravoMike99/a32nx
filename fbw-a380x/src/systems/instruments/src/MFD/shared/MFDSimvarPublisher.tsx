...
export class MfdSimvarPublisher extends SimVarPublisher<MfdSimvars> {
  private static simvars = new Map<keyof MfdSimvars, SimVarDefinition>([
    ...
    ['adirs1MaintWord', { name: MfdVars.adirs1MaintWord, type: SimVarValueType.Enum }],
    ['adirs2MaintWord', { name: MfdVars.adirs2MaintWord, type: SimVarValueType.Enum }],
    ['adirs3MaintWord', { name: MfdVars.adirs3MaintWord, type: SimVarValueType.Enum }],
