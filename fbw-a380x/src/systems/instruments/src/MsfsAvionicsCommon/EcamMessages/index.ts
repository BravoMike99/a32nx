...
export const EcamMemos: { [n: string]: string } = {
  ...
  // SIGNS ON OPTION
  '000001004': '   \x1b<5m-SIGNS .........ON',
  '000001005': '   \x1b<3m-SIGNS ON',
  // CABIN READY OPTION
  '000001006': '\x1b<5m-CABIN..........CHECK',
  '000001007': '\x1b<3m-CABIN : READY',
  // GND SPLRS OPTION
  ...
  '000001016': '   \x1b<3m-AUTO BRK RTO',
  '000001017': '   \x1b<5m-T.O CONFIG ..TEST',
  '000001018': '   \x1b<3m-T.O CONFIG NORM',
...
export enum NormalProcedureType {
  ...
  DEPARTURE_CHANGE,
  AFTER_TAKEOFF,
  ALL_PHASES_DEFERRED_PROCEDURE,
  BEFORE_TOD_DEFERRED_PROCEDURE,
  DESCENT,
  BEFORE_APPROACH_DEFERRED_PROCEDURE,
  APPROACH,
  BEFORE_LANDING_DEFERRED_PROCEDURE,
  LANDING,
  AFTER_LANDING,
  PARKING,
  SECURE,
...
export const DEFERRED_PROCEDURES_IDS = [
...
export const DEPARTURE_CHANGE_NORMAL_CHECKLIST_ID_TEXT = NormalProcedureType[NormalProcedureType.DEPARTURE_CHANGE];
